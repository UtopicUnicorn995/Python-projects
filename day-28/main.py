...
start_button = Button(text="Start", width=12, highlightthickness=0, command=start_timer)
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", width=12, highlightthickness=0, command=reset_timer)
